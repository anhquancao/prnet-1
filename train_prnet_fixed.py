    ...
    for epoch in range(start_epoch, var.epochs):
        ...
        for data in tqdm(train_loader, position=0, leave=True):
            ...
            if it % eval_every == 0:
                ...
                ex.log_scalar("training.t_ab_mse", t_ab_mse, it)
                ex.log_scalar("training.t_ab_rmse", t_ab_rmse, it)            
                ...
                with torch.no_grad():
                    ...
                    ex.log_scalar("eval.t_ab_mse", info_test['t_ab_mse'], it)
                    ex.log_scalar("eval.t_ab_rmse", info_test['t_ab_rmse'], it)            
