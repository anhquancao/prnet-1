...
from util import transform_point_cloud, npmat2euler, quat2mat, mat2euler
...
class PRNet(nn.Module):
    ...
    def _train_one_epoch(self, epoch, train_loader, opt, dataset="modelnet40"):
        assert dataset in ['modelnet40', 'nuscenes']
        self.train()
        total_loss = 0
        rotations_ab = []
        translations_ab = []
    ...
    def _test_one_epoch(self, epoch, test_loader, dataset="modelnet40"):
        assert dataset in ['modelnet40', 'nuscenes']
        self.eval()
        total_loss = 0
        rotations_ab = []
